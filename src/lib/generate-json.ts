...
export function generateStoreJson(state: OnboardingState): StoreConfig {
  ...
  return {
    ...
    proveedor: {
      leadType: state.registro.leadType,
      nombre: state.registro.nombre,
      cargo: state.registro.cargo,
      empresa: state.registro.empresa,
      ruc: state.registro.ruc,
      documentPersonType: state.registro.documentPersonType,
      documentType: state.registro.documentType,
      documentNumber: state.registro.documentNumber,
      documentDeferred: state.registro.documentDeferred,
